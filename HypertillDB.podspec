...
Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://github.com/hypertilll/hypertillDB.git", :tag => "v#{s.version}" }
  ...
  s.public_header_files = [
    ...
    # but this is needed for HypertillDB to work in use_frameworks! mode
    # 'native/ios/**/*.h',
    'native/ios/HypertillDB/JSIInstaller.h',
    'native/ios/HypertillDB/HypertillDB.h',
  ]
