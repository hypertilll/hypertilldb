...
const copyNonJavaScriptFiles = (buildPath) => {
  ...
  cleanFolder(`${buildPath}/native/ios/HypertillDB.xcodeproj/xcuserdata`)
  ...
  cleanFolder(`${buildPath}/native/windows/HypertillDB/Generated Files`)
  cleanFolder(`${buildPath}/native/windows/HypertillDB/obj`)
  cleanFolder(`${buildPath}/native/windows/HypertillDB/x64`)
}
...
if (isDevelopment) {
  ...
  chokidar
    .watch(
      [
        resolvePath('src'),
        resolvePath('native/ios/HypertillDB'),
