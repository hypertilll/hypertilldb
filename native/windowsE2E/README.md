This is a very hacky way of getting output from Windows HypertillTester into CI, based on RNW's e2e-test-app project:
...
But it's not the right way to do this. Ideally, we'd run HypertillTester itself in native "test" mode, just like iOS or Android.
