...
void Database::install(jsi::Runtime *runtime) {
    ...
    createMethod(rt, globalObject, "nativeHypertillCreateAdapter", 2, [runtime](jsi::Runtime &rt, const jsi::Value *args) {
        ...
        // Without any hacks, JSI Hypertill crashes on Android/Hermes on app reload in development:
        ...
        //   hypertilldb::SqliteDb::~SqliteDb() Sqlite.cpp:57
        ...
        // HypertillJSI via reflection (and switch to the currect thread - important!) and then to
        // individual Database objects via this listener callback. It's ugly, but should work.
        //
        // 2023 update: Check if the above is still true, given https://github.com/helapoint/hypertill-db/issues/1474
