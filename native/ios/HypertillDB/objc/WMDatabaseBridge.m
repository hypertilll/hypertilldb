...
- (dispatch_queue_t) methodQueue
{
    ...
    return dispatch_queue_create("com.hypertill.db.database", attr);
}
...
{
    NSError *error;
    hypertilldbProvideSyncJson(id.intValue, [json dataUsingEncoding:NSUTF8StringEncoding], &error);
    if (error) {
