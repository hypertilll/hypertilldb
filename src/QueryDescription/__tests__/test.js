...
describe('buildQueryDescription', () => {
  ...
  it('protect against passing Hypertill look-alike objects', () => {
    // protect against passing something that could be a user-input Object (risk is when Hypertill users pass stuff from JSON without validation), but is unintended or even malicious in some way
