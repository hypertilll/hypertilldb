...
export default function getSyncChanges(
  ...
  steps.forEach((step) => {
    invariant(
      ...
      `Unknown migration step type ${step.type}. Can not perform migration sync. This most likely means your migrations are defined incorrectly. It could also be a HypertillDB bug.`,
    )
  })
