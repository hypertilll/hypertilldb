...
/**
 * String that signifies a database table name (mapping to HypertillDB Models)
 */
export opaque type TableName<+T: Model>: string = string

/**
 * String that signifies a database column name (mapping to HypertillDB fields)
 */
...
const validateName = (name: string) => {
  if (process.env.NODE_ENV !== 'production') {
    invariant(
      ...
      `Invalid column or table name '${name}' - reserved by HypertillDB`,
    )
