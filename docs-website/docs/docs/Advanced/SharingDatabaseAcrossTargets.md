...
In case you have multiple Xcode targets and want to share your Hypertill DB instance across them, there are 2 options to be followed: via JS or via native Swift / Objective-C.
...
This tells iOS to share storage directories between your targets, and in this case, also the Hypertill database.
...
This way you're telling Hypertill to store your database into the shared directories, you're ready to go!
