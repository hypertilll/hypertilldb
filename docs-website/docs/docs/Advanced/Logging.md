...
By default, Hypertill ships with basic logging enabled that may be useful for debugging. When the application is started, basic information
...
```js
import logger from '@hypertill/db/utils/common/logger';
logger.silence();
```
